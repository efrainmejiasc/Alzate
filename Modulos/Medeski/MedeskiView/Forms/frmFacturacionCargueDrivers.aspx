<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="frmFacturacionCargueDrivers.aspx.cs" Inherits="MedeskiView.Forms.frmFacturacionCargueDrivers" %>
    ...
    <div id="ContenidoDer" class="container-fluid" onclick="cerrarMenu()" >
        <div id="Titulos" class="titulo1">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Cargue de Drivers</li>
            </ol>
        </div>
        <div id="SubTitulos" class="titulo2">
            <h6>Cargue Gastos de Drivers<br /></h6>
        </div>
        <div id="ContenedorFormulario" class="">
            <div class="form-row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <dx:ASPxTextBox runat="server" Width="100%" Height="150" ID="txtPendientes" ReadOnly="true" ClientInstanceName="txtPendientes" Visible="false" BackColor="#fcfcfc">
                    </dx:ASPxTextBox>
                </div>
            </div>
        ...
        <dx:ASPxGridView ID="grid_Driver" ClientInstanceName="grid_Driver" runat="server"
            ...
            <Columns>
                ...
                <%--<dx:GridViewDataColumn FieldName="dto_generic_valor_distribucion" Caption="Proveedor" VisibleIndex="11" />--%>
        ...
        <dx:ASPxGridView ID="gridPendientes" ClientInstanceName="gridPendientes" runat="server"
            ...
            EnableRowsCache="False" EnableCallBacks="False"
            KeyFieldName="dto_generic_id_consecutivo" Width="100%" OnPageIndexChanged="gridPendientes_PageIndexChanged">
            <Settings GridLines="Horizontal" />
            <Columns>
