<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="frmCargueDistribucionPersonas.aspx.cs" Inherits="MedeskiView.Forms.frmCargueDistribucionPersonas"  %>
      ...
      <div id="ContenidoDer" class="container-fluid" onclick="cerrarMenu()" >
          ...
          <div id="ContenedorFormulario" class="">
              ...
              <dx:ASPxGridView ID="gvPpto" runat="server" AutoGenerateColumns="False" CssClass="gridview" Width="100%" ClientInstanceName="gvPpto" EnableRowsCache="False">
                  ...
                  <Columns>
                      <dx:GridViewDataColumn Caption="Colaborador" FieldName="Colaborador" VisibleIndex="0" Visible="true" HeaderStyle-HorizontalAlign="Center" > </dx:GridViewDataColumn>

                      <dx:GridViewDataColumn Caption="Cedula" FieldName ="Cedula" VisibleIndex="1" Visible="true" HeaderStyle-HorizontalAlign="Center"> </dx:GridViewDataColumn>

                      <dx:GridViewDataColumn Caption="Criterio de Distribucion" FieldName="CriterioDistribucion" VisibleIndex="2" Visible="true" HeaderStyle-HorizontalAlign="Center"> </dx:GridViewDataColumn>

                      <dx:GridViewDataColumn Caption="Tipo de Distribucion" FieldName="TipoDistribucion" Visible="false" HeaderStyle-HorizontalAlign="Left"> </dx:GridViewDataColumn>

                       <dx:GridViewDataColumn Caption="Codigo de  Area" FieldName="CodigoArea"  Visible="false" HeaderStyle-HorizontalAlign="Left"> </dx:GridViewDataColumn>

                      <dx:GridViewDataColumn Caption="Area" FieldName="Area" VisibleIndex="3" Visible="true" HeaderStyle-HorizontalAlign="Left"> </dx:GridViewDataColumn>

                      <dx:GridViewDataColumn Caption="Descripcion" FieldName="Descripcion" VisibleIndex="4" Visible="true" HeaderStyle-HorizontalAlign="Left"> </dx:GridViewDataColumn>

                       <dx:GridViewDataColumn Caption="Codigo Descripcion" FieldName="CodigoDescripcion" VisibleIndex="5" Visible="true" HeaderStyle-HorizontalAlign="Left"> </dx:GridViewDataColumn>

                      <dx:GridViewDataColumn Caption="Porcentaje de Distribucion" FieldName="PorcentajeDistribucion" VisibleIndex="6" Visible="true" HeaderStyle-HorizontalAlign="Left"> </dx:GridViewDataColumn>

                      <dx:GridViewDataColumn Caption="Observacion" FieldName="Observacion" VisibleIndex="7" Visible="true" HeaderStyle-HorizontalAlign="Center"> </dx:GridViewDataColumn>

                      <dx:GridViewDataColumn Caption="Fecha" FieldName="Fecha" Visible="false" HeaderStyle-HorizontalAlign="Center"> </dx:GridViewDataColumn>

                       <dx:GridViewDataColumn Caption="Periodo" FieldName="Periodo" Visible="false" HeaderStyle-HorizontalAlign="Center"> </dx:GridViewDataColumn>

                      <dx:GridViewDataColumn Caption="Usuario" FieldName="Usuario" Visible="false" HeaderStyle-HorizontalAlign="Center"> </dx:GridViewDataColumn>

                       <dx:GridViewDataColumn Caption="Estado" FieldName="Estado" Visible="false" HeaderStyle-HorizontalAlign="Center"> </dx:GridViewDataColumn>

                        <dx:GridViewDataColumn Caption="PersonaConsecutivo" FieldName="PersonaConsecutivo" Visible="false" HeaderStyle-HorizontalAlign="Center"> </dx:GridViewDataColumn>
