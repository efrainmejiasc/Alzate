<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="frmDistribucionInfraestructuraProd.aspx.cs" Inherits="MedeskiView.Forms.frmDistribucionInfraestructuraProd" %>
    ...
    <div id="ContenidoDer" class="container-fluid" onclick="cerrarMenu()" >
        <div id="Titulos" class="titulo1">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Valor Distribución Infraestructura - Productos</li>
            </ol>
        </div>
        
        <div id="SubTitulos" class="titulo2">
		    <h6>Valor Distribución Infraestructura - Productos<br /></h6>
	    </div>
        ...
        <dx:ASPxGridView runat="server" ID="grid" AutoGenerateColumns="False" Theme="MetropolisBlue" CssClass="gridview"
            ...
            <Columns>
                ...
                <dx:GridViewDataSpinEditColumn FieldName="vlrservprod" Caption="Valor" VisibleIndex="2" PropertiesSpinEdit-AllowMouseWheel="false" PropertiesSpinEdit-AllowNull="true" 
            ...
            <TotalSummary>
                <dx:ASPxSummaryItem FieldName="vlrservprod" SummaryType="Sum" Tag="Total"/>
            </TotalSummary>
        </dx:ASPxGridView>
