<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="frmDistribucionInfraestructuraDataCenter.aspx.cs" Inherits="MedeskiView.Forms.frmDistribucionInfraestructuraDataCenter" %>
    ...
    <div id="ContenidoDer" class="container-fluid" onclick="cerrarMenu()" >
        <div id="Titulos" class="titulo1">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Valor Distribución Infraestructura - DataCenter</li>
            </ol>
        </div>
        
        <div id="SubTitulos" class="titulo2">
		    <h6>Valor Distribución Infraestructura - DataCenter<br /></h6>
	    </div>
        ...
        <dx:ASPxGridView runat="server" ID="grid" AutoGenerateColumns="False" Theme="MetropolisBlue" CssClass="gridview"
            ...
            <Columns>
                ...
                <dx:GridViewDataSpinEditColumn FieldName="vlritemdatacenter" Caption="Valor" VisibleIndex="2" PropertiesSpinEdit-AllowMouseWheel="false" PropertiesSpinEdit-AllowNull="true" 
            ...
            <TotalSummary>
                <dx:ASPxSummaryItem FieldName="vlritemdatacenter" SummaryType="Sum" Tag="Total"/>
            </TotalSummary>
        </dx:ASPxGridView>
